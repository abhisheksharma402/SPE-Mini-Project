...
public class TestMain {
    ...
    public void testSqrt() {
        assertEquals(Double.NaN, Main.sqrt(-4), 0.001); // Square root of 4 is 2.0
    ...
    public void testFactorial() {
        assertEquals(1.0, Main.factorial(0), 0.001); // Factorial of 0 is 1
        assertEquals(1.0, Main.factorial(1), 0.001); // Factorial of 1 is 1
        assertEquals(Double.NaN, Main.factorial(-3), 0.001); // Factorial of negative numbers are not real
        assertEquals(24.0, Main.factorial(4), 0.001); // Factorial of 4 is 24
    }

    @Test
    public void testLn() {
        assertEquals(Double.NaN, Main.ln(-4), 0.001); // Natural log of negative numbers is undefined
